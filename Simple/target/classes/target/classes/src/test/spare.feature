...
Scenario: Anytime  12 months current - One Time Payment - Chrome
...
Scenario: Anytime  12 months Wellbeing current - One Time Payment - Chrome
...
Scenario: Anytime  3 months current - One Time Payment - Chrome
...
Scenario: Off peak -  12 months current - One Time Payment - Chrome
...
Scenario: Off Peak  12 months Wellbeing current - One Time Payment - Chrome
...
Scenario: Anytime  12 months current - Direct Debit - Chrome
...
Scenario: Anytime  12 months WB - current date - Direct Debit - Chrome
...
Scenario: Anytime  3 months current - Direct Debit - Chrome
...
Scenario: Off peak  12 months current - Direct Debit - Chrome
...
Scenario: Offpeak  12 months WB - current date - Direct Debit - Chrome
...
Scenario: Offpeak  3 months current - Direct Debit - Chrome
...
Scenario: Anytime  12 months current - One Time Payment - IE
...
Scenario: Anytime  12 months Wellbeing current - One Time Payment - IE
...
Scenario: Anytime  3 months current - One Time Payment - IE
...
Scenario: Off peak -  12 months current - One Time Payment - IE
...
Scenario: Off Peak  12 months Wellbeing current - One Time Payment - IE
...
Scenario: Anytime  12 months current - Direct Debit - IE
...
Scenario: Anytime  12 months WB - current date - Direct Debit - IE
...
Scenario: Anytime  3 months current - Direct Debit - IE
...
Scenario: Off peak  12 months current - Direct Debit - IE
...
Scenario: Offpeak  12 months WB - current date - Direct Debit - IE
...
Scenario: Offpeak  3 months current - Direct Debit - IE
...
Scenario: Anytime  3 months - Direct Debit DISCOUT 10% FF

Given I start "shoreditch"
Then I am on page "aber"
...
Then I get amount value "total"
Then I get amount "member"
When I verify that "membership" is "195.00"
Then I grab amount "fee"
...
Then I open opportunity
Then I am on page "Opportunity"
Then I can see "Site" filled with "Shoreditch"
Then I can see "Amount" filled with "total"
Then I can see "Order Reference" filled with "orid"
Then I can see "Payment Reference" filled with "pay"
Then I do save